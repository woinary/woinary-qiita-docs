...
:::note info
ここではプログラマとSEという分け方で書きました。しかし、同じようなことをコーダとプログラマという分け方をするケースもあります。例えばこの記事。

日経XTECH[技術者に未来なし、「コーダー」という呼び名に潜む人月商売の闇](https://xtech.nikkei.com/atcl/nxt/column/18/00148/072500071/)

ここではコーダーを符号（コード＝プログラミング言語、特にHTMLやCSSとは限定していない）を書くだけの人としており、それに対してプログラマはコンピュータに何かを行う手順を行う人＝設計も含む、としています。つまりは上に書いたSEとプログラマの事と同じことを言っていると解釈しています。
この意見が正しいとか正しくないとかは個々人で考えていただくとして、同じことを言っていても用語が異なるのが現状だということです。
:::
